  ...
  useEffect(() => {
    async function loadProfile() {
      try {
        ...
        console.error(
          "Failed to load medical officer profile:",
          err
        );
        ...
        <div className="mx-auto w-full max-w-[1100px]">
          ...
          <div className="mb-7 text-center">
            ...
            <p className="mt-3 text-sm text-[#858b97] sm:text-base">
              Your medical account, unit details & access information
            </p>
          </div>
          ...
          {/* Account Details + Medical Access */}
          <div className="mt-6 grid gap-6 lg:grid-cols-2">

            <AccountDetails profile={profile} />

            <MedicalAccessInformation />
...
function MedicalAccessInformation() {
  return (
    <section
      className="
        rounded-[26px]
    ...
    >
      ...
      <div className="mt-5 space-y-4">
        <AccessItem>
          You can review welfare cases assigned to
          authorized medical personnel.
        </AccessItem>

        <AccessItem>
          Detailed assessment information is available
          according to the welfare review protocol.
        </AccessItem>

        <AccessItem>
          Welfare interventions can be recorded through
          the authorized medical workflow.
        </AccessItem>

        <AccessItem>
          Your access is determined by your medical officer
          role and assigned unit.
        </AccessItem>
      </div>
    </section>
  );
